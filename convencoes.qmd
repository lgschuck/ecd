...
|---------------------------------|----------|-------------|
| Funções, operadores do R        | Código   | `print`     |
| Objetos od R, termos relevantes | Negrito  | **Negrito** |
| Palavras de língua estrangeira  | Itálico  | *Itálico*   |
...
| Funções                          | camelCase iniciado por **fn**, sendo a primeira palavra após fn será um verbo | fnBuscarClientes         |
