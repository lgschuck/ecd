...
Os pacotes podem, e em sua maioria, utilizam funções de outros pacotes. Estes "outrous pacotes" são denominadas de dependências. As informações de dependências também constam no *DESCRIPTION* do pacote.
