...
```{r, fig.cap = "Menu Tools", echo = FALSE}
...
```{r, fig.cap = "Install Packages", echo = FALSE}
...
```{r, fig.cap = "Install From", echo = FALSE}
  knitr::include_graphics('images/rstudio/menu_tools_inst_pkgs_from.png')
```

```{r, fig.cap = "Package Archive File", echo = FALSE}
...
```{r, fig.cap = "Check for Package Updates", echo = FALSE}
...
```{r, fig.cap = "Global Options", echo = FALSE}
