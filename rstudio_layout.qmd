...
```{r, fig.cap = "Console", out.width="90%", echo = FALSE}
...
```{r, fig.cap = "Files", out.width="90%", echo = FALSE}
...
```{r, fig.cap = "Environment", out.width="90%", echo = FALSE}
...
```{r, fig.cap = "Source", out.width="90%", echo = FALSE}
